...
<form method="post" enctype="multipart/form-data" class="bundle_form" action="<?php echo get_permalink( ); ?>"><?php
				...
				?><div class="bundle_button"><?php
					...
					foreach ( $bundled_items as $bundled_item_id => $bundled_item ) {
						...
						if ( $bundled_product->product_type === 'variable' ) {
							...
							?><input type="hidden" name="bundle_variation_id_<?php echo $bundled_item_id; ?>" class="bundle_variation_id_<?php echo $bundled_item_id; ?>" value="" />
							<?php
